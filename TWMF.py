...
delimiter = ','
training_file_name = 'Musical_Instruments_5_training.csv'
test_file_name = 'Musical_Instruments_5_test.csv'
raw_data_file_name = 'Musical_Instruments_5.csv'
#############################
...
recommendation_user_number = 800
recommendation_list_length = 100
alpha = 12
m = Matrix(training_file_name, test_file_name, alpha=0)
m.recommendation_list = list()
for i in range(recommendation_user_number):
    m.generate_recommendation_random(user=i, recommendation_list_length=recommendation_list_length)
...
m = Matrix(training_file_name, test_file_name, alpha=alpha)
# print ("{}\t{}\t{}\t{}".format(m.user_number, m.item_number, m.rating_number, m.global_mean))

m.train(alpha=alpha)

m.recommendation_list = list()
for i in range(recommendation_user_number):
    m.generate_recommendation(user = i, recommendation_list_length=recommendation_list_length)
